...
select 
    ...
    city
from tblInsa
    where city in ('서울', '인천') and substr(name,1,1) like '김%';
...
select 
    ...
    ibsadate
from tblInsa
    where substr(ibsadate,1,2) in (08,09,10);
...
select 
    ...
    ibsadate
from tblInsa
    where substr(ibsadate,1,2) between 08 and 10;
